...
public class ContratoDAOPostgre {
    ...
    public int ingresarContrato(Contrato contrato)throws ExcepcionSQL{
    ...
    public int modificarContrato(Contrato contrato) throws ExcepcionSQL{
        int registros_afectados;
    ...
    public List<Contrato> buscarContratos(int idempleado)throws ExcepcionSQL{
    ...
    public Contrato verificarContrato(int idContrato) throws ExcepcionSQL{
    ...
    public int anularContrato(Contrato contrato) throws ExcepcionSQL{
        int registros_afectados;
        String sentenciaSQL = "update contrato set condicion = 'ANULADO' "
                + "where idcontrato = ?";
    ...
    public int actualizarEstadoContrato(Contrato contrato) throws ExcepcionSQL{
        int registros_afectados;
        String sentenciaSQL = "update contrato set condicion = 'TERMINADO' "
                + " where idcontrato = ?";
        try {
            PreparedStatement sentencia = gestorJDBC.prepararSentencia(sentenciaSQL);
            sentencia.setInt(1, contrato.getIdcontrato());
    ...
    public List<Contrato> buscarContratosActivos()throws ExcepcionSQL{
