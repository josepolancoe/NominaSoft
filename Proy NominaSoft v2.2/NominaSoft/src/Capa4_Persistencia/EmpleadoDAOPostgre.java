...
public class EmpleadoDAOPostgre {
    ...
    public int ingresarEmpleado(Empleado empleado) throws ExcepcionSQL{
    ...
    public int modificarEmpleado(Empleado empleado) throws ExcepcionSQL{
        int registros_afectados;
    ...
    public int eliminarEmpleado(Empleado empleado) throws ExcepcionSQL{
        int registros_afectados;
    ...
    public Empleado verificarEmpleado(String dni) throws ExcepcionSQL{
    ...
    public Empleado buscarEmpleado(int idEmpleado) throws Exception {
        Empleado empleado = null;
        ResultSet resultado;
        String sentenciaSQL = " Select idempleado, dni, nombre, fechanacimiento, gradoacademico, estadocivil,"
                             +" telefono, direccion"
