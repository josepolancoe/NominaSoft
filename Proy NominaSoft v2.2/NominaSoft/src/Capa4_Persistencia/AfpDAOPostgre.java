...
public class AfpDAOPostgre {
    ...
    public int ingresarAfp(Afp afp) throws ExcepcionSQL{
    ...
    public int modificarAfp(Afp afp) throws ExcepcionSQL{
        int registros_afectados;
    ...
    public int eliminarAfp(Afp afp) throws ExcepcionSQL{
        int registros_afectados;
    ...
    public List<Afp> buscarAfps()throws ExcepcionSQL{
    ...
    public Afp verificarAfp(int idAfp) throws ExcepcionSQL{
        Afp afp = null;
        ResultSet resultado;
        ...
        public Afp verificarNombreAfp(String nombre) throws ExcepcionSQL{
        Afp afp = null;
        ResultSet resultado;
        String sentenciaSQL = "select idafp, nombre, porcentaje"
                            + " from afp"
