...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //Prueba unitaria del metodo verifiContratoVigente cuando la fecha está correcta y la condicion es Anulado
    ...
    public void test2VerificarContratoVigente() {
        System.out.println("verificarContratoVigente");
        java.sql.Date fechaFinC = java.sql.Date.valueOf("2019-12-22");
        java.sql.Date fechaInicioC = java.sql.Date.valueOf("2019-06-1");
        Contrato instance = new Contrato();
        instance.setCondicion("ANULADO");  
        instance.setFechafincontrato(fechaFinC);
        instance.setFechainiciocontrato(fechaInicioC);
        Boolean expResult = false;
        Boolean result = instance.verificarContratoVigente();
        assertEquals(expResult, result);
    }
    ...
    public void test3VerificarContratoVigente() {
        System.out.println("verificarContratoVigente");
        java.sql.Date fechaFinC = java.sql.Date.valueOf("2019-12-25");
        java.sql.Date fechaInicioC = java.sql.Date.valueOf("2019-06-1");        
        Contrato instance = new Contrato();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @Test
    public void test1VerificarValorHora() {
    ...
    @Test
    public void test2VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Secundaria");
        contrato.setEmpleado(empleado);
        contrato.setValorhora(5);
        Boolean expResult = true;
        Boolean result = contrato.verificarValorHora();
        assertEquals(expResult, result);
    }
    ...
    @Test
    public void test3VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
    ...
    @Test
    public void test4VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
    ...
    @Test
    public void test5VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
    ...
    @Test
    public void test6VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
    ...
    @Test
    public void test7VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Primaria");
    ...
    @Test
    public void test8VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Secundaria");
    ...
    @Test
    public void test9VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Bachiller");
    ...
    @Test
    public void test10VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Profesional");
    ...
    @Test
    public void test11VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Magister");
    ...
    @Test
    public void test12VerificarValorHora() {
        System.out.println("verificarValorHora");
        Contrato contrato = new Contrato();
        Empleado empleado = new Empleado();
        empleado.setGradoacademico("Doctor");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void test1VerificarFechaInicioContratoNuevo() {
        ...
        contratoAnterior.setFechafincontrato(fechaFinContratoPrevio);
        contratoAnterior.setCondicion("Activo");
        contratoAnterior.setIdcontrato(1);
        Boolean expResult = true;
        Boolean result = contrato.verificarFechaInicioContratoNuevo(contratoAnterior);
        assertEquals(expResult, result);
    }
    ...
    public void test2VerificarFechaInicioContratoNuevo() {
        ...
        Contrato contratoAnterior = new Contrato();
        contratoAnterior.setFechafincontrato(fechaFinContratoPrevio);
        contratoAnterior.setCondicion("Anulado");
        contratoAnterior.setIdcontrato(2);
        Boolean expResult = true;
        Boolean result = contrato.verificarFechaInicioContratoNuevo(contratoAnterior);
        assertEquals(expResult, result);
    }
    ...
    // de un contrato anterior
    @Test
    public void test3VerificarFechaInicioContratoNuevo() {
        System.out.println("verificarFechaInicioContratoNuevo");
        java.sql.Date fechaInicioContratoNuevo = java.sql.Date.valueOf("2019-12-02");
        Contrato contrato = new Contrato();
        contrato.setFechainiciocontrato(fechaInicioContratoNuevo);
        contrato.setIdcontrato(1);
        Contrato contratoAnterior = new Contrato();
        contratoAnterior.setIdcontrato(0);
        Boolean expResult = true;
        Boolean result = contrato.verificarFechaInicioContratoNuevo(contratoAnterior);
        assertEquals(expResult, result);
    }   
    ...
    // de un contrato anterior
    @Test
    public void test4VerificarFechaInicioContratoNuevo() {
        System.out.println("verificarFechaInicioContratoNuevo");
        java.sql.Date fechaFinContratoPrevio = java.sql.Date.valueOf("2019-10-03");
        java.sql.Date fechaInicioContratoNuevo = java.sql.Date.valueOf("2019-05-03");
        Contrato contrato = new Contrato();
        contrato.setFechainiciocontrato(fechaInicioContratoNuevo);
